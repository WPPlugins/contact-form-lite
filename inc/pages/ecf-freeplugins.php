...
.ecf-container-cnt .plugin-card {
    border: 1px solid #d7d7d7 !important;
}

.ecf-container-cnt .plugin-card-bottom {
    border-top: 1px solid #c2c2c2 !important;
	background-color: #efefef !important;
}

.most_popular {top: -5px;position: absolute;width: 115px;height: 85px;background: transparent url("<?php echo ECF_URL;?>/inc/images/most_popular.png") no-repeat scroll left top;right: -5px;}
...
jQuery(document).ready(function($) {
	...
	var theLists = ['easy-media-gallery', 'contact-form-lite', 'feed-instagram-lite', 'image-slider-widget', 'gallery-lightbox-slider', 'image-carousel','icon', 'easy-notify-lite'];
