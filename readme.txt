...
== Description ==
[Homepage](http://demo.ghozylab.com/plugins/easy-contact-form-plugin/) | [Documentation](https://www.youtube.com/watch?v=_3lsRi9C77k) | [Support](https://ghozylab.com/plugins/submit-support-request/#tab-1399384216-2-4) | [Demo](http://demo.ghozylab.com/plugins/easy-contact-form-plugin/demo-form-with-image-in-header/) | [Premium Version](http://demo.ghozylab.com/plugins/easy-contact-form-plugin/)
...
Not only does the form plugin take care of the functionality, it can very easily make your [form](http://demo.ghozylab.com/plugins/easy-contact-form-plugin/ "contact form") look great too. For the more advanced user, you will NOT be disappointed with the flexibility of the styling features of this **form plugin**.
...
The best thing about **Contact Form** plugin is that you can easily send forms without re-loading the page.
...
* [Gallery](http://wordpress.org/plugins/easy-media-gallery/ "gallery plugin") - Easy Media Gallery is a wordpress plugin designed to display various media support including grid gallery, galleries, photo album, multiple photo albums, portfolio, photo gallery or image gallery.
* [Image Slider](https://wordpress.org/plugins/image-slider-widget/ "slider plugin") - Easy Image Slider Widget - Displaying your image as slider in widget/sidebar area with very easy. Allows you to customize it to looking exactly what you want.
...
* [Icon Fonts](https://wordpress.org/plugins/icon/ "Icon Fonts Plugin") - Select and insert icon into your post or page just in one click. More than 2.5k icons available.
* [Popup Builder](http://wordpress.org/plugins/easy-notify-lite/ "optin form plugin") -  The Best Notify and Subscription Form Plugin to display notify popup, announcement and subscribe form with very ease, fancy and elegant.
